...
struct SignUpVCProvider: PreviewProvider {
	...
	struct ContainerView: UIViewControllerRepresentable {
		...
		func updateUIViewController(_ uiViewController: SignUpVCProvider.ContainerView.UIViewControllerType,
									context:UIViewControllerRepresentableContext<SignUpVCProvider.ContainerView>) {
		}
	}
}
